...
public class AMEntityRegistry {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EntitySnowLeopard>> SNOW_LEOPARD = DEF_REG.register("snow_leopard", () -> registerEntity(EntityType.Builder.of(EntitySnowLeopard::new, MobCategory.CREATURE).sized(1.2F, 1.3F).immuneTo(BlockTags.POLAR_BEAR_IMMUNE_TO).setTrackingRange(10), "snow_leopard"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EntityCachalotEcho>> CACHALOT_ECHO = DEF_REG.register("cachalot_echo", () -> registerEntity(EntityType.Builder.of(EntityCachalotEcho::new, MobCategory.MISC).sized(2F, 2F).fireImmune().setShouldReceiveVelocityUpdates(true).setUpdateInterval(1).setTrackingRange(10), "cachalot_echo"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EntityFroststalker>> FROSTSTALKER = DEF_REG.register("froststalker", () -> registerEntity(EntityType.Builder.of(EntityFroststalker::new, MobCategory.CREATURE).sized(0.95F, 1.15F).immuneTo(BlockTags.POLAR_BEAR_IMMUNE_TO), "froststalker"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EntityTusklin>> TUSKLIN = DEF_REG.register("tusklin", () -> registerEntity(EntityType.Builder.of(EntityTusklin::new, MobCategory.CREATURE).sized(2.2F, 1.9F).immuneTo(BlockTags.POLAR_BEAR_IMMUNE_TO).setTrackingRange(10), "tusklin"));
