...
public class EntityRoadrunner extends Animal {
    ...
    public void readAdditionalSaveData(ValueInput compound) {
        ...
        if (((ValueInputExtension) (Object) compound).keySet().contains("FeatherTime")) {
    ...
    protected SoundEvent getAmbientSound() {
        return isMeep() || this.getRandom().nextInt(2000) == 0 ? AMSoundRegistry.ROADRUNNER_MEEP.get() : AMSoundRegistry.ROADRUNNER_IDLE.get();
    }
    ...
    public AgeableMob getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
        return AMEntityRegistry.ROADRUNNER.get().create(p_241840_1_, EntitySpawnReason.BREEDING);
    }
