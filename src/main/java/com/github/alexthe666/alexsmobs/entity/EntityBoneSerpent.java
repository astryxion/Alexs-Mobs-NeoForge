...
public class EntityBoneSerpent extends Monster {
    ...
    private static final EntityDataAccessor<Optional<UUID>> CHILD_UUID = SynchedEntityData.defineId(EntityBoneSerpent.class, AMEntityRegistry.OPTIONAL_UUID_SERIALIZER.get());
