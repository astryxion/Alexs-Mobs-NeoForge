...
public class EntityMurmur extends Monster implements ISemiAquatic {
    ...
    private static final EntityDataAccessor<Optional<UUID>> HEAD_UUID = SynchedEntityData.defineId(EntityMurmur.class, AMEntityRegistry.OPTIONAL_UUID_SERIALIZER.get());
