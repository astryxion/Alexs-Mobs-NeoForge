...
public class ModelElephant extends AlexAdvancedEntityModel<EntityElephant> {
    ...
    /**
     * Copies live pose from another elephant model (same mesh layout), used by {@code LayerElephantOverlays}
     * before running {@link #setupAnim} on the overlay model.
     */
    public void copyPropertiesTo(ModelElephant target) {
