...
public class ModelCrocodile extends AlexAdvancedEntityModel<EntityCrocodile> {
    ...
    public void setupAnim(EntityCrocodile entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (swimAnimate) {
            ...
            // TODO 1.21: Citadel API changed - this.walk(right_arm);
        ...
        if (baskProgress > 0) {
            // TODO 1.21: Citadel API changed - this.walk(head);
