...
public class ParticleGusterSandSpin extends SingleQuadParticle {
    ...
    private ParticleGusterSandSpin(ClientLevel world, double x, double y, double z, double motionX, double motionY, double motionZ, int variant, SpriteSet sprites, RandomSource random) {
        super(world, x, y, z, 0.0D, 0.0D, 0.0D, sprites.get(random));
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, RandomSource random) {
            return new ParticleGusterSandSpin(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, 0, spriteSet, random);
        }
    }
    public static class FactoryRed implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, RandomSource random) {
            return new ParticleGusterSandSpin(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, 1, spriteSet, random);
        }
    }
    public static class FactorySoul implements ParticleProvider<SimpleParticleType> {
        ...
        @Override
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, RandomSource random) {
            return new ParticleGusterSandSpin(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, 2, spriteSet, random);
        }
    }
}
