...
public class ModelFlyingFish extends AlexAdvancedEntityModel<EntityFlyingFish> {
    ...
    public void setupAnim(EntityFlyingFish entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        // TODO 1.21: Citadel API changed - this.flap(left_pelvicFin);
        ...
        // TODO 1.21: Citadel API changed - this.chainSwing(tailBoxes);
