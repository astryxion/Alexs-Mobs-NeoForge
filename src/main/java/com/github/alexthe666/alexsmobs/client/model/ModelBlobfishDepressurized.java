...
public class ModelBlobfishDepressurized extends AlexAdvancedEntityModel<EntityBlobfish> {
    ...
    public void setupAnim(EntityBlobfish entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
        ...
        float lvt_6_1_ = Mth.lerp(Minecraft.getInstance().getDeltaTracker().getGameTimeDeltaPartialTick(true), entity.prevSquishFactor, entity.squishFactor);
