...
public class ModelBananaSlug extends AlexAdvancedEntityModel<EntityBananaSlug> {
    ...
    public void renderToBuffer(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, int color) {
        if (this.young) {
            ...
            matrixStackIn.pushPose();
            parts().forEach(part -> part.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, color));
            matrixStackIn.popPose();
        }
