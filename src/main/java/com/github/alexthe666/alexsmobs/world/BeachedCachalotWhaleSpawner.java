...
public class BeachedCachalotWhaleSpawner {
    ...
    private boolean attemptSpawnWhale() {
        ...
        if (playerentity == null) {
            ...
            if (blockpos2 != null && this.func_226559_a_(blockpos2) && blockpos2.distSqr(blockpos) > 225) {
                ...
                EntityCachalotWhale whale = AMEntityRegistry.CACHALOT_WHALE.get().create(world, EntitySpawnReason.SPAWNER);
    ...
    private BlockPos func_221244_a(BlockPos p_221244_1_, int p_221244_2_) {
        ...
        for(int i = 0; i < 10; ++i) {
            ...
            if (AMWorldRegistry.testBiome(BiomeConfig.cachalot_whale_beached_spawns, world.getBiome(blockpos1)) && NaturalSpawner.isValidEmptySpawnBlock(world, blockpos1, world.getBlockState(blockpos1), world.getFluidState(blockpos1), AMEntityRegistry.CACHALOT_WHALE.get())) {
                blockpos = blockpos1;
                break;
            }
        }
