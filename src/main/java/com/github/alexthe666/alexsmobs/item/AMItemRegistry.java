...
public class AMItemRegistry {
    ...
    public static void initSpawnEggs() {
        DEF_REG.registerItem("spawn_egg_grizzly_bear", props -> new AMSpawnEggItem(props, 0X693A2C, 0X976144), () -> spawnEggProperties(AMEntityRegistry.GRIZZLY_BEAR));
        DEF_REG.registerItem("spawn_egg_roadrunner", props -> new AMSpawnEggItem(props, 0X3A2E26, 0XFBE9CE), () -> spawnEggProperties(AMEntityRegistry.ROADRUNNER));
        DEF_REG.registerItem("spawn_egg_bone_serpent", props -> new AMSpawnEggItem(props, 0XE5D9C4, 0XFF6038), () -> spawnEggProperties(AMEntityRegistry.BONE_SERPENT));
        DEF_REG.registerItem("spawn_egg_gazelle", props -> new AMSpawnEggItem(props, 0XDDA675, 0X2C2925), () -> spawnEggProperties(AMEntityRegistry.GAZELLE));
        DEF_REG.registerItem("spawn_egg_crocodile", props -> new AMSpawnEggItem(props, 0X738940, 0XA6A15E), () -> spawnEggProperties(AMEntityRegistry.CROCODILE));
        DEF_REG.registerItem("spawn_egg_fly", props -> new AMSpawnEggItem(props, 0X464241, 0X892E2E), () -> spawnEggProperties(AMEntityRegistry.FLY));
        DEF_REG.registerItem("spawn_egg_hummingbird", props -> new AMSpawnEggItem(props, 0X325E7F, 0X44A75F), () -> spawnEggProperties(AMEntityRegistry.HUMMINGBIRD));
        DEF_REG.registerItem("spawn_egg_orca", props -> new AMSpawnEggItem(props, 0X2C2C2C, 0XD6D8E4), () -> spawnEggProperties(AMEntityRegistry.ORCA));
        DEF_REG.registerItem("spawn_egg_sunbird", props -> new AMSpawnEggItem(props, 0XF6694F, 0XFFDDA0), () -> spawnEggProperties(AMEntityRegistry.SUNBIRD));
        DEF_REG.registerItem("spawn_egg_gorilla", props -> new AMSpawnEggItem(props, 0X595B5D, 0X1C1C21), () -> spawnEggProperties(AMEntityRegistry.GORILLA));
        DEF_REG.registerItem("spawn_egg_crimson_mosquito", props -> new AMSpawnEggItem(props, 0X53403F, 0XC11A1A), () -> spawnEggProperties(AMEntityRegistry.CRIMSON_MOSQUITO));
        DEF_REG.registerItem("spawn_egg_rattlesnake", props -> new AMSpawnEggItem(props, 0XCEB994, 0X937A5B), () -> spawnEggProperties(AMEntityRegistry.RATTLESNAKE));
        DEF_REG.registerItem("spawn_egg_endergrade", props -> new AMSpawnEggItem(props, 0X7862B3, 0x81BDEB), () -> spawnEggProperties(AMEntityRegistry.ENDERGRADE));
        DEF_REG.registerItem("spawn_egg_hammerhead_shark", props -> new AMSpawnEggItem(props, 0X8A92B5, 0XB9BED8), () -> spawnEggProperties(AMEntityRegistry.HAMMERHEAD_SHARK));
        DEF_REG.registerItem("spawn_egg_lobster", props -> new AMSpawnEggItem(props, 0XC43123, 0XDD5F38), () -> spawnEggProperties(AMEntityRegistry.LOBSTER));
        DEF_REG.registerItem("spawn_egg_komodo_dragon", props -> new AMSpawnEggItem(props, 0X746C4F, 0X564231), () -> spawnEggProperties(AMEntityRegistry.KOMODO_DRAGON));
        DEF_REG.registerItem("spawn_egg_capuchin_monkey", props -> new AMSpawnEggItem(props, 0X25211F, 0XF1DAB3), () -> spawnEggProperties(AMEntityRegistry.CAPUCHIN_MONKEY));
        DEF_REG.registerItem("spawn_egg_centipede", props -> new AMSpawnEggItem(props, 0X342B2E, 0X733449), () -> spawnEggProperties(AMEntityRegistry.CENTIPEDE_HEAD));
        DEF_REG.registerItem("spawn_egg_warped_toad", props -> new AMSpawnEggItem(props, 0X1F968E, 0XFEAC6D), () -> spawnEggProperties(AMEntityRegistry.WARPED_TOAD));
        DEF_REG.registerItem("spawn_egg_moose", props -> new AMSpawnEggItem(props, 0X36302A, 0XD4B183), () -> spawnEggProperties(AMEntityRegistry.MOOSE));
        DEF_REG.registerItem("spawn_egg_mimicube", props -> new AMSpawnEggItem(props, 0X8A80C1, 0X5E4F6F), () -> spawnEggProperties(AMEntityRegistry.MIMICUBE));
        DEF_REG.registerItem("spawn_egg_raccoon", props -> new AMSpawnEggItem(props, 0X85827E, 0X2A2726), () -> spawnEggProperties(AMEntityRegistry.RACCOON));
        DEF_REG.registerItem("spawn_egg_blobfish", props -> new AMSpawnEggItem(props, 0XDBC6BD, 0X9E7A7F), () -> spawnEggProperties(AMEntityRegistry.BLOBFISH));
        DEF_REG.registerItem("spawn_egg_seal", props -> new AMSpawnEggItem(props, 0X483C32, 0X66594C), () -> spawnEggProperties(AMEntityRegistry.SEAL));
        DEF_REG.registerItem("spawn_egg_cockroach", props -> new AMSpawnEggItem(props, 0X0D0909, 0X42241E), () -> spawnEggProperties(AMEntityRegistry.COCKROACH));
        DEF_REG.registerItem("spawn_egg_shoebill", props -> new AMSpawnEggItem(props, 0X828282, 0XD5B48A), () -> spawnEggProperties(AMEntityRegistry.SHOEBILL));
        DEF_REG.registerItem("spawn_egg_elephant", props -> new AMSpawnEggItem(props, 0X8D8987, 0XEDE5D1), () -> spawnEggProperties(AMEntityRegistry.ELEPHANT));
        DEF_REG.registerItem("spawn_egg_soul_vulture", props -> new AMSpawnEggItem(props, 0X23262D, 0X57F4FF), () -> spawnEggProperties(AMEntityRegistry.SOUL_VULTURE));
        DEF_REG.registerItem("spawn_egg_snow_leopard", props -> new AMSpawnEggItem(props, 0XACA293, 0X26201D), () -> spawnEggProperties(AMEntityRegistry.SNOW_LEOPARD));
        DEF_REG.registerItem("spawn_egg_spectre", props -> new AMSpawnEggItem(props, 0XC8D0EF, 0X8791EF), () -> spawnEggProperties(AMEntityRegistry.SPECTRE));
        DEF_REG.registerItem("spawn_egg_crow", props -> new AMSpawnEggItem(props, 0X0D111C, 0X1C2030), () -> spawnEggProperties(AMEntityRegistry.CROW));
        DEF_REG.registerItem("spawn_egg_alligator_snapping_turtle", props -> new AMSpawnEggItem(props, 0X6C5C52, 0X456926), () -> spawnEggProperties(AMEntityRegistry.ALLIGATOR_SNAPPING_TURTLE));
        DEF_REG.registerItem("spawn_egg_mungus", props -> new AMSpawnEggItem(props, 0X836A8D, 0X45454C), () -> spawnEggProperties(AMEntityRegistry.MUNGUS));
        DEF_REG.registerItem("spawn_egg_mantis_shrimp", props -> new AMSpawnEggItem(props, 0XDB4858, 0X15991E), () -> spawnEggProperties(AMEntityRegistry.MANTIS_SHRIMP));
        DEF_REG.registerItem("spawn_egg_guster", props -> new AMSpawnEggItem(props, 0XF8D49A, 0XFF720A), () -> spawnEggProperties(AMEntityRegistry.GUSTER));
        DEF_REG.registerItem("spawn_egg_warped_mosco", props -> new AMSpawnEggItem(props, 0X322F58, 0X5B5EF1), () -> spawnEggProperties(AMEntityRegistry.WARPED_MOSCO));
        DEF_REG.registerItem("spawn_egg_straddler", props -> new AMSpawnEggItem(props, 0X5D5F6E, 0XCDA886), () -> spawnEggProperties(AMEntityRegistry.STRADDLER));
        DEF_REG.registerItem("spawn_egg_stradpole", props -> new AMSpawnEggItem(props, 0X5D5F6E, 0X576A8B), () -> spawnEggProperties(AMEntityRegistry.STRADPOLE));
        DEF_REG.registerItem("spawn_egg_emu", props -> new AMSpawnEggItem(props, 0X665346, 0X3B3938), () -> spawnEggProperties(AMEntityRegistry.EMU));
        DEF_REG.registerItem("spawn_egg_platypus", props -> new AMSpawnEggItem(props, 0X7D503E, 0X363B43), () -> spawnEggProperties(AMEntityRegistry.PLATYPUS));
        DEF_REG.registerItem("spawn_egg_dropbear", props -> new AMSpawnEggItem(props, 0X8A2D35, 0X60A3A3), () -> spawnEggProperties(AMEntityRegistry.DROPBEAR));
        DEF_REG.registerItem("spawn_egg_tasmanian_devil", props -> new AMSpawnEggItem(props, 0X252426, 0XA8B4BF), () -> spawnEggProperties(AMEntityRegistry.TASMANIAN_DEVIL));
        DEF_REG.registerItem("spawn_egg_kangaroo", props -> new AMSpawnEggItem(props, 0XCE9D65, 0XDEBDA0), () -> spawnEggProperties(AMEntityRegistry.KANGAROO));
        DEF_REG.registerItem("spawn_egg_cachalot_whale", props -> new AMSpawnEggItem(props, 0X949899, 0X5F666E), () -> spawnEggProperties(AMEntityRegistry.CACHALOT_WHALE));
        DEF_REG.registerItem("spawn_egg_leafcutter_ant", props -> new AMSpawnEggItem(props, 0X964023, 0XA65930), () -> spawnEggProperties(AMEntityRegistry.LEAFCUTTER_ANT));
        DEF_REG.registerItem("spawn_egg_enderiophage", props -> new AMSpawnEggItem(props, 0X872D83, 0XF6E2CD), () -> spawnEggProperties(AMEntityRegistry.ENDERIOPHAGE));
        DEF_REG.registerItem("spawn_egg_bald_eagle", props -> new AMSpawnEggItem(props, 0X321F18, 0XF4F4F4), () -> spawnEggProperties(AMEntityRegistry.BALD_EAGLE));
        DEF_REG.registerItem("spawn_egg_tiger", props -> new AMSpawnEggItem(props, 0XC7612E, 0X2A3233), () -> spawnEggProperties(AMEntityRegistry.TIGER));
        DEF_REG.registerItem("spawn_egg_tarantula_hawk", props -> new AMSpawnEggItem(props, 0X234763, 0XE37B38), () -> spawnEggProperties(AMEntityRegistry.TARANTULA_HAWK));
        DEF_REG.registerItem("spawn_egg_void_worm", props -> new AMSpawnEggItem(props, 0X0F1026, 0X1699AB), () -> spawnEggProperties(AMEntityRegistry.VOID_WORM));
        DEF_REG.registerItem("spawn_egg_frilled_shark", props -> new AMSpawnEggItem(props, 0X726B6B, 0X873D3D), () -> spawnEggProperties(AMEntityRegistry.FRILLED_SHARK));
        DEF_REG.registerItem("spawn_egg_mimic_octopus", props -> new AMSpawnEggItem(props, 0XFFEBDC, 0X1D1C1F), () -> spawnEggProperties(AMEntityRegistry.MIMIC_OCTOPUS));
        DEF_REG.registerItem("spawn_egg_seagull", props -> new AMSpawnEggItem(props, 0XC9D2DC, 0XFFD850), () -> spawnEggProperties(AMEntityRegistry.SEAGULL));
        DEF_REG.registerItem("spawn_egg_froststalker", props -> new AMSpawnEggItem(props, 0X788AC1, 0XA1C3FF), () -> spawnEggProperties(AMEntityRegistry.FROSTSTALKER));
        DEF_REG.registerItem("spawn_egg_tusklin", props -> new AMSpawnEggItem(props, 0X735841, 0XE8E2D5), () -> spawnEggProperties(AMEntityRegistry.TUSKLIN));
        DEF_REG.registerItem("spawn_egg_laviathan", props -> new AMSpawnEggItem(props, 0XD68356, 0X3C3947), () -> spawnEggProperties(AMEntityRegistry.LAVIATHAN));
        DEF_REG.registerItem("spawn_egg_cosmaw", props -> new AMSpawnEggItem(props, 0X746DBD, 0XD6BFE3), () -> spawnEggProperties(AMEntityRegistry.COSMAW));
        DEF_REG.registerItem("spawn_egg_toucan", props -> new AMSpawnEggItem(props, 0XF58F33, 0X1E2133), () -> spawnEggProperties(AMEntityRegistry.TOUCAN));
        DEF_REG.registerItem("spawn_egg_maned_wolf", props -> new AMSpawnEggItem(props, 0XBB7A47, 0X40271A), () -> spawnEggProperties(AMEntityRegistry.MANED_WOLF));
        DEF_REG.registerItem("spawn_egg_anaconda", props -> new AMSpawnEggItem(props, 0X565C22, 0XD3763F), () -> spawnEggProperties(AMEntityRegistry.ANACONDA));
        DEF_REG.registerItem("spawn_egg_anteater", props -> new AMSpawnEggItem(props, 0X4C3F3A, 0XCCBCB4), () -> spawnEggProperties(AMEntityRegistry.ANTEATER));
        DEF_REG.registerItem("spawn_egg_rocky_roller", props -> new AMSpawnEggItem(props, 0XB0856F, 0X999184), () -> spawnEggProperties(AMEntityRegistry.ROCKY_ROLLER));
        DEF_REG.registerItem("spawn_egg_flutter", props -> new AMSpawnEggItem(props, 0X70922D, 0XD07BE3), () -> spawnEggProperties(AMEntityRegistry.FLUTTER));
        DEF_REG.registerItem("spawn_egg_gelada_monkey", props -> new AMSpawnEggItem(props, 0XB08C64, 0XFF4F53), () -> spawnEggProperties(AMEntityRegistry.GELADA_MONKEY));
        DEF_REG.registerItem("spawn_egg_jerboa", props -> new AMSpawnEggItem(props, 0XDEC58A, 0XDE9D90), () -> spawnEggProperties(AMEntityRegistry.JERBOA));
        DEF_REG.registerItem("spawn_egg_terrapin", props -> new AMSpawnEggItem(props, 0X6E6E30, 0X929647), () -> spawnEggProperties(AMEntityRegistry.TERRAPIN));
        DEF_REG.registerItem("spawn_egg_comb_jelly", props -> new AMSpawnEggItem(props, 0XCFE9FE, 0X6EFF8B), () -> spawnEggProperties(AMEntityRegistry.COMB_JELLY));
        DEF_REG.registerItem("spawn_egg_cosmic_cod", props -> new AMSpawnEggItem(props, 0X6985C7, 0XE2D1FF), () -> spawnEggProperties(AMEntityRegistry.COSMIC_COD));
        DEF_REG.registerItem("spawn_egg_bunfungus", props -> new AMSpawnEggItem(props, 0X6F6D91, 0XC92B29), () -> spawnEggProperties(AMEntityRegistry.BUNFUNGUS));
        DEF_REG.registerItem("spawn_egg_bison", props -> new AMSpawnEggItem(props, 0X4C3A2E, 0X7A6546), () -> spawnEggProperties(AMEntityRegistry.BISON));
        DEF_REG.registerItem("spawn_egg_giant_squid", props -> new AMSpawnEggItem(props, 0XAB4B4D, 0XD67D6B), () -> spawnEggProperties(AMEntityRegistry.GIANT_SQUID));
        DEF_REG.registerItem("spawn_egg_devils_hole_pupfish", props -> new AMSpawnEggItem(props, 0X567BC4, 0X6C4475), () -> spawnEggProperties(AMEntityRegistry.DEVILS_HOLE_PUPFISH));
        DEF_REG.registerItem("spawn_egg_catfish", props -> new AMSpawnEggItem(props, 0X807757, 0X8A7466), () -> spawnEggProperties(AMEntityRegistry.CATFISH));
        DEF_REG.registerItem("spawn_egg_flying_fish", props -> new AMSpawnEggItem(props, 0X7BBCED, 0X6881B3), () -> spawnEggProperties(AMEntityRegistry.FLYING_FISH));
        DEF_REG.registerItem("spawn_egg_skelewag", props -> new AMSpawnEggItem(props, 0XD9FCB1, 0X3A4F30), () -> spawnEggProperties(AMEntityRegistry.SKELEWAG));
        DEF_REG.registerItem("spawn_egg_rain_frog", props -> new AMSpawnEggItem(props, 0XC0B59B, 0X7B654F), () -> spawnEggProperties(AMEntityRegistry.RAIN_FROG));
        DEF_REG.registerItem("spawn_egg_potoo", props -> new AMSpawnEggItem(props, 0X8C7753, 0XFFC042), () -> spawnEggProperties(AMEntityRegistry.POTOO));
        DEF_REG.registerItem("spawn_egg_mudskipper", props -> new AMSpawnEggItem(props, 0X60704A, 0X49806C), () -> spawnEggProperties(AMEntityRegistry.MUDSKIPPER));
        DEF_REG.registerItem("spawn_egg_rhinoceros", props -> new AMSpawnEggItem(props, 0XA19594, 0X827474), () -> spawnEggProperties(AMEntityRegistry.RHINOCEROS));
        DEF_REG.registerItem("spawn_egg_sugar_glider", props -> new AMSpawnEggItem(props, 0X868181, 0XEBEBE0), () -> spawnEggProperties(AMEntityRegistry.SUGAR_GLIDER));
        DEF_REG.registerItem("spawn_egg_farseer", props -> new AMSpawnEggItem(props, 0X33374F, 0X91FF59), () -> spawnEggProperties(AMEntityRegistry.FARSEER));
        DEF_REG.registerItem("spawn_egg_skreecher", props -> new AMSpawnEggItem(props, 0X074857, 0X7FF8FF), () -> spawnEggProperties(AMEntityRegistry.SKREECHER));
        DEF_REG.registerItem("spawn_egg_underminer", props -> new AMSpawnEggItem(props, 0XD6E2FF, 0X6C84C4), () -> spawnEggProperties(AMEntityRegistry.UNDERMINER));
        DEF_REG.registerItem("spawn_egg_murmur", props -> new AMSpawnEggItem(props, 0X804448, 0XB5AF9C), () -> spawnEggProperties(AMEntityRegistry.MURMUR));
        DEF_REG.registerItem("spawn_egg_skunk", props -> new AMSpawnEggItem(props, 0X222D36, 0XE4E5F2), () -> spawnEggProperties(AMEntityRegistry.SKUNK));
        DEF_REG.registerItem("spawn_egg_banana_slug", props -> new AMSpawnEggItem(props, 0XFFD045, 0XFFF173), () -> spawnEggProperties(AMEntityRegistry.BANANA_SLUG));
        DEF_REG.registerItem("spawn_egg_blue_jay", props -> new AMSpawnEggItem(props, 0X5FB7FE, 0X293B42), () -> spawnEggProperties(AMEntityRegistry.BLUE_JAY));
        DEF_REG.registerItem("spawn_egg_caiman", props -> new AMSpawnEggItem(props, 0X5C5631, 0XBBC45C), () -> spawnEggProperties(AMEntityRegistry.CAIMAN));
        DEF_REG.registerItem("spawn_egg_triops", props -> new AMSpawnEggItem(props, 0X967954, 0XCA7150), () -> spawnEggProperties(AMEntityRegistry.TRIOPS));
    ...
    private static Item.Properties spawnEggProperties(DeferredHolder<EntityType<?>, ? extends EntityType<?>> type) {
        ResourceKey<EntityType<?>> key = type.getKey();
        return new Item.Properties().delayedComponent(DataComponents.ENTITY_DATA, context ->
                TypedEntityData.of(context.getOrThrow(key).value(), new CompoundTag()));
    }
